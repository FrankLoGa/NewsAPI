 ...
 */
export declare type ApiNewsCountry = 'ae' | 'ar' | 'at' | 'au' | 'be' | 'bg' | 'br' | 'ca' | 'ch' | 'cn' | 'co' | 'cu' | 'cz' | 'de' | 'eg' | 'fr' | 'gb' | 'gr' | 'hk' | 'hu' | 'id' | 'ie' | 'il' | 'in' | 'it' | 'jp' | 'kr' | 'lt' | 'lv' | 'ma' | 'mx' | 'my' | 'ng' | 'nl' | 'no' | 'nz' | 'ph' | 'pl' | 'pt' | 'ro' | 'rs' | 'ru' | 'sa' | 'se' | 'sg' | 'si' | 'sk' | 'th' | 'tr' | 'tw' | 'ua' | 'us' | 've' | 'za';
/**
 * The 2-letter ISO-639-1 code of the language
 */
export declare type ApiNewsLanguage = 'ar' | 'de' | 'en' | 'es' | 'fr' | 'he' | 'it' | 'nl' | 'no' | 'pt' | 'ru' | 'se' | 'ud' | 'zh';
/**
 * If the request was successful or not. Options: ok, error. In the case of error a code and message property will be populated.
 */
export declare type ApiNewsResponseStatus = 'ok' | 'error';
/**
 * Possible category
 */
export declare type ApiNewsCategory = 'business' | 'entertainment' | 'general' | 'health' | 'science' | 'sports' | 'technology';
/**
 ...
 */
export declare type ApiNewsSort = 'relevancy' | 'popularity' | 'publishedAt';
/**
